...
<?php 
	...
	<form class="form-horizontal" method="POST" action="member_save.php" enctype="multipart/form-data">
		...
		<div class="control-group">
			<label class="control-label" for="inputPassword">Teacher ID:</label>
			<div class="controls">
			<input type="text" class="search" name="contact"  placeholder="Teacher ID"  autocomplete="off"  maxlength="12" >
			</div>
		</div>
		<div class="control-group">
