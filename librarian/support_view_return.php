			...
			<div class="row">	
				<div class="span12">		
                        ...
                        <ul class="nav nav-pills">
										...
										<li><a href="s5_view_return.php">Senior 5</a></li>
                                        ...
                                        <li     class="active"><a href="support_view_return.php">Supporting Staff</a></li>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
								...
								where borrowdetails.borrow_status = 'returned'  and member.type='Supporting staff' ORDER BY borrow.borrow_id DESC
								  ")or die(mysqli_error());
