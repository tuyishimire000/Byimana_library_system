...
<?php include('navbar_borrow.php'); ?>
    ...
    <div class="container">
		...
		<form method="POST" action="class_borrow_save.php">
<div class="span3">
				...
				<option></option>
				<?php $result =  mysqli_query($conn,"select * from class_container")or die(mysqli_error()); 
				while ($row=mysqli_fetch_array($result)){ ?>
				<option value="<?php echo $row['class_id']; ?>"><?php echo $row['class']." ".$row['section']; ?></option>
				<?php } ?>
				</select>
				</div>
			</div>
				<div class="control-group"> 
					<label class="control-label" for="inputEmail"  onkeyup='saveValue(this);'>Return Date</label>
				<div class="controls">
				...
				<div class="control-group"> 
				<label class="control-label" for="inputEmail">Class Representative</label>
				<div class="controls">
				<input  type="text" id="cleader" style="width:200px;" name="cleader"   placeholder="Class Representative" onkeyup='saveValue(this);'>
                </div>
				</div>
						...
						<div class="alert alert-success"><strong>Select Book</strong></div>
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($conn,"select * from book where status != 'Archive' ")or die(mysqli_error($conn));
                                    ...
                                    <td width="20">
												<input id="checkBox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $id; ?>" >
...
$(".uniform_on").change(function(){
    ...
    if( $(".uniform_on:checked").length == max ){
        ...
        $(".uniform_on").attr('disabled', 'disabled');
		         alert('1 Book is allowed at a time');
...
document.getElementById("cleader").value = getSavedValue("cleader");    // set the value to this input
       // document.getElementById("checkBox").value = getSavedValue("checkBox");   // set the value to this input
