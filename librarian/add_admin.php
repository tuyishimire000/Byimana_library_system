...
<?php 
    ...
    <div class="container">
		<div class="margin-top">
			...
			<div class="span12">	
             ...
             <div class="alert alert-info">Add Adminstration</div>
	...
	<form class="form-horizontal" method="POST" action="member_save.php" enctype="multipart/form-data">
		...
		<div class="control-group">
			<label class="control-label" for="inputPassword">Administator ID:</label>
			<div class="controls">
			<input type="text" class="search" name="contact"  placeholder="Administator ID"  autocomplete="off"  maxlength="12" >
			</div>
		</div>
		<div class="control-group">
