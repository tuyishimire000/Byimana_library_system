			...
			<div class="row">	
				<div class="span12">	
                        ...
                        <ul class="nav nav-pills">
										...
										<li><a href="s3_view_class_borrow.php">Senior 3</a></li>
										<li class="active"><a href="s4_view_class_borrow.php">Senior 4</a></li>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example" style="margin-top:00px;">
                                ...
                                where class_borrowdetails.borrow_status='pending' and  class_container.class='s4'
