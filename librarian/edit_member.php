...
<?php $get_id = $_GET['id']; ?>
	...
	<form class="form-horizontal" method="POST" action="update_member.php" enctype="multipart/form-data">
		...
		<!--<div class="control-group">
			...
			<div class="controls">
			<input type="text" id="inputPassword" name="address" value="<?php echo $row['address']; ?>" placeholder="Class" required>
			</div>
		</div>-->
		<div class="control-group">
			<label class="control-label" for="inputPassword">Student ID:</label>
			<div class="controls">
			<input type="text" id="inputPassword" name="contact" value="<?php echo $row['contact']; ?>" placeholder="Student ID" >
