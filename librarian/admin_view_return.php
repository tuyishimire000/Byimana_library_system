			...
			<div class="row">	
				<div class="span12">		
                        ...
                        <ul class="nav nav-pills">
                                        ...
                                        <li     class="active"><a href="admin_view_return.php">Administrators</a></li>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
								...
								where borrowdetails.borrow_status = 'returned'  and member.type='Administration' ORDER BY borrow.borrow_id DESC
								  ")or die(mysqli_error());
