			...
			<div class="row">	
				<div class="span12">		
                        ...
                        <ul class="nav nav-pills">
                                        ...
                                        <li    class="active"><a href="s6_view_return.php">Senior 6</a></li>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
								...
								where borrowdetails.borrow_status = 'returned'  and member.year_level='s6' ORDER BY borrow.borrow_id DESC
								  ")or die(mysqli_error());
